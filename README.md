...
This package is to help data wrangling with `arviz.InferenceData`
objects, in the flavor of
[tidybayes](https://mjskay.github.io/tidybayes/index.html).

All of the dataframes are polars, some of the geom functions convert to
pandas internally where required.
