---
title: "Tidy Bayesian Analysis, in Python"
format: gfm
jupyter: python3
---
...
Color and other aesthetics can be mapped to the visualization with the grammar of graphics and the tidy data framework.
...
Density only — no point estimate or intervals. Useful for overlaying distributions.
